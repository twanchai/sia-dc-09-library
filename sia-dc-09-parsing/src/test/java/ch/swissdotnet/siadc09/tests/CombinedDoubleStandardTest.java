...
public class CombinedDoubleStandardTest {
    ...
    public void parseAckCorrectlyHexUpper() throws InvalidMessageException {
        ...
        message = handler.read(serialized.message(), globalParameters, sptStore);
        serialized = handler.write(message, globalParameters, sptParameters);
